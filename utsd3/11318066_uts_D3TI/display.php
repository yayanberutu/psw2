...
<tr>
		<td class="t_header" style="text-align: center">Red <?=$p1?> %</td>
		<td class="t_header" style="text-align: center">Green <?=$p2?> %</td>
		<td class="t_header"style="text-align: center">Blue <?=$p3?> %</td>
</tr>
